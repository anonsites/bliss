...
export const FALLBACK_NEARBY_USERS: NearbyUser[] = [
  {
    id: "mkt-nearby-1",
    username: "Sasha",
    avatarUrl: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/profiles/Yvettes.jpg`,
    mediaSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Yvette_p1.jpg`,
    posterSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Yvette_p1.jpg`,
    mediaType: "image",
    distance: "Nearby",
    isVerified: true,
  },
  {
    id: "mkt-nearby-2",
    username: "Marcus",
    avatarUrl: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/profiles/Pazzo.jpg`,
    mediaSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Pazzo_p1.jpg`,
    posterSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Pazzo_p1.jpg`,
    mediaType: "image",
    distance: "Top Pick",
    isVerified: false,
  },
  ...
  },
  {
    id: "mkt-nearby-7",
    username: "Taylor",
    avatarUrl: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/profiles/Devotha.jpg`,
    mediaSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Devotha_p1.jpg`,
    posterSrc: `${CLOUDINARY_BASE}/image/upload/v1/bliss/marketing_content/gallery/Devotha_p1.jpg`,
    mediaType: "image",
    distance: "3.5 km",
    isVerified: true,
  },
